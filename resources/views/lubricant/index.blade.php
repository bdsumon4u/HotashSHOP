...
<body>
    ...
    <div class="dvLayout">
        ...
        <div id="mainSiteContent">
            <section class="heading-section area-padding container">
                <div class="head-paragraph">
                    <span>{{$company->name}} - quality meets desires </span>
                    <h1>High Quality Lubricating Oil Company.</h1>
                </div>
                <div class="row">
                    <div class="col-lg-7 col-12 align-self-center">
                        <div>
                            <p><strong>SAAH Traders</strong> is a top-rated lubricating oil company that
                                produces and provides top-graded lube oil, meeting the needs of all types of engines to
                                boost the power of quality oil.</p>
                            <p class="h5"><strong>We provide lube oil for a wide range of machines
                                    including</strong></p>
                            <div class="row">
                                <div class="col-md-6">
                                    <ul class="list-group mb-2 text-capitalize">
                                        @foreach($parentCategories as $category)
                                        @if($loop->even)
                                        <li class="list-group-item">
                                            <a href="{{ route('categories.products', $category) }}">{{$category->name}} <span>⤏</span></a>
                                        </li>
                                        @endif
                                        @endforeach
                                    </ul>
                            ...
                            <p><b>SAAH Traders</b> produces and provides lower carbon, quality
                                petrochemical products with a commitment to the standards of sustainability that our
                                society needs today and for years to come. </p>
                            <a href="{{ route('products.index') }}" class="animated-btn">View All Products</a>
                        </div>
                    </div>
                    <div class="col-lg-5 col-12 d-none d-lg-block align-self-center">
                        <div class="img-box">
                            <img class="lazyload" data-src="/inc/offer.jpeg"
                                src="#" alt="Boost Engine Power Using {{$company->name}}" height="500"
                                width="400">
                        </div>
                    </div>
                </div>
            ...
            <section class="product area-padding">
                <div class="custom-container">
                    <div class="head-paragraph">
                        ...
                        <h2>Lubricating Oil / Products We Provide</h2>
                    </div>
