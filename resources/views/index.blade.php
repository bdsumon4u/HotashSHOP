                ...
                <div class="block-products-carousel__column">
                    <div class="block-products-carousel__cell">
                        <div class="product-card"><button class="product-card__quickview" type="button"><svg
                                    ...
                                    <use xlink:href="{{ asset('strokya/images/sprite.svg#quickview-16') }}"></use>
                                </svg> <span class="fake-svg-icon"></span></button>
                            <div class="product-card__badges-list">
                                <div class="product-card__badge product-card__badge--new">New</div>
                            </div>
                            <div class="product-card__image"><a href="product.html"><img
                                        src="{{ asset('strokya/images/products/product-1.jpg') }}" alt=""></a></div>
                                    ...
                                    <div class="rating">
                                        <div class="rating__body"><svg
                                                ...
                                                <g class="rating__fill">
                                                    <use xlink:href="{{ asset('strokya/images/sprite.svg#star-normal') }}"></use>
                                                </g>
                                                <g class="rating__stroke">
                                                    <use xlink:href="{{ asset('strokya/images/sprite.svg#star-normal-stroke') }}">
                                                    </use>
                                                </g>
                                            </svg>
                                            <div
                            ...
                            <div class="product-card__actions">
                                ...
                                <div class="product-card__buttons"><button
                                        ...
                                        type="button"><svg width="16px" height="16px">
                                            <use xlink:href="{{ asset('strokya/images/sprite.svg#wishlist-16') }}"></use>
                                        </svg> <span
                                            class="fake-svg-icon fake-svg-icon--wishlist-16"></span></button>
                                    <button
                                        class="btn btn-light btn-svg-icon btn-svg-icon--fake-svg product-card__compare"
                                        type="button"><svg width="16px" height="16px">
                                            <use xlink:href="{{ asset('strokya/images/sprite.svg#compare-16') }}"></use>
                                        </svg> <span
                ...
                <div class="block-products-carousel__column">
                    <div class="block-products-carousel__cell">
                        <div class="product-card"><button class="product-card__quickview" type="button"><svg
                            ...
                            <div class="product-card__image"><a href="product.html"><img
                                        src="{{ asset('strokya/images/products/product-2.jpg') }}" alt=""></a></div>
                            <div class="product-card__info">
                ...
                <div class="block-products-carousel__column">
                    <div class="block-products-carousel__cell">
                        <div class="product-card"><button class="product-card__quickview" type="button"><svg
                            ...
                            <div class="product-card__image"><a href="product.html"><img
                                        src="{{ asset('strokya/images/products/product-3.jpg') }}" alt=""></a></div>
                            <div class="product-card__info">
                ...
                <div class="block-products-carousel__column">
                    <div class="block-products-carousel__cell">
                        <div class="product-card"><button class="product-card__quickview" type="button"><svg
                            ...
                            <div class="product-card__image"><a href="product.html"><img
                                        src="{{ asset('strokya/images/products/product-4.jpg') }}" alt=""></a></div>
                            <div class="product-card__info">
                ...
                <div class="block-products-carousel__column">
                    <div class="block-products-carousel__cell">
                        <div class="product-card"><button class="product-card__quickview" type="button"><svg
                            ...
                            <div class="product-card__image"><a href="product.html"><img
                                        src="{{ asset('strokya/images/products/product-5.jpg') }}" alt=""></a></div>
                            <div class="product-card__info">
                ...
                <div class="block-products-carousel__column">
                    <div class="block-products-carousel__cell">
                        <div class="product-card"><button class="product-card__quickview" type="button"><svg
                            ...
                            <div class="product-card__image"><a href="product.html"><img
                                        src="{{ asset('strokya/images/products/product-6.jpg') }}" alt=""></a></div>
                            <div class="product-card__info">
                ...
                <div class="block-products-carousel__column">
                    <div class="block-products-carousel__cell">
                        <div class="product-card"><button class="product-card__quickview" type="button"><svg
                            ...
                            <div class="product-card__image"><a href="product.html"><img
                                        src="{{ asset('strokya/images/products/product-7.jpg') }}" alt=""></a></div>
                            <div class="product-card__info">
                ...
                <div class="block-products-carousel__column">
                    <div class="block-products-carousel__cell">
                        <div class="product-card"><button class="product-card__quickview" type="button"><svg
                            ...
                            <div class="product-card__image"><a href="product.html"><img
                                        src="{{ asset('strokya/images/products/product-8.jpg') }}" alt=""></a></div>
                            <div class="product-card__info">
                ...
                <div class="block-products-carousel__column">
                    <div class="block-products-carousel__cell">
                        <div class="product-card"><button class="product-card__quickview" type="button"><svg
                            ...
                            <div class="product-card__image"><a href="product.html"><img
                                        src="{{ asset('strokya/images/products/product-9.jpg') }}" alt=""></a></div>
                            <div class="product-card__info">
                ...
                <div class="block-products-carousel__column">
                    <div class="block-products-carousel__cell">
                        <div class="product-card"><button class="product-card__quickview" type="button"><svg
                            ...
                            <div class="product-card__image"><a href="product.html"><img
                                        src="{{ asset('strokya/images/products/product-10.jpg') }}" alt=""></a></div>
                            <div class="product-card__info">
                ...
                <div class="block-products-carousel__column">
                    <div class="block-products-carousel__cell">
                        <div class="product-card"><button class="product-card__quickview" type="button"><svg
                            ...
                            <div class="product-card__image"><a href="product.html"><img
                                        src="{{ asset('strokya/images/products/product-11.jpg') }}" alt=""></a></div>
                            <div class="product-card__info">
                ...
                <div class="block-products-carousel__column">
                    <div class="block-products-carousel__cell">
                        <div class="product-card"><button class="product-card__quickview" type="button"><svg
                            ...
                            <div class="product-card__image"><a href="product.html"><img
                                        src="{{ asset('strokya/images/products/product-12.jpg') }}" alt=""></a></div>
                            <div class="product-card__info">
                ...
                <div class="block-products-carousel__column">
                    <div class="block-products-carousel__cell">
                        <div class="product-card"><button class="product-card__quickview" type="button"><svg
                            ...
                            <div class="product-card__image"><a href="product.html"><img
                                        src="{{ asset('strokya/images/products/product-13.jpg') }}" alt=""></a></div>
                            <div class="product-card__info">
                ...
                <div class="block-products-carousel__column">
                    <div class="block-products-carousel__cell">
                        <div class="product-card"><button class="product-card__quickview" type="button"><svg
                            ...
                            <div class="product-card__image"><a href="product.html"><img
                                        src="{{ asset('strokya/images/products/product-14.jpg') }}" alt=""></a></div>
                            <div class="product-card__info">
                ...
                <div class="block-products-carousel__column">
                    <div class="block-products-carousel__cell">
                        <div class="product-card"><button class="product-card__quickview" type="button"><svg
                            ...
                            <div class="product-card__image"><a href="product.html"><img
                                        src="{{ asset('strokya/images/products/product-15.jpg') }}" alt=""></a></div>
                            <div class="product-card__info">
                ...
                <div class="block-products-carousel__column">
                    <div class="block-products-carousel__cell">
                        <div class="product-card"><button class="product-card__quickview" type="button"><svg
                            ...
                            <div class="product-card__image"><a href="product.html"><img
                                        src="{{ asset('strokya/images/products/product-16.jpg') }}" alt=""></a></div>
                            <div class="product-card__info">
    ...
    <div class="container">
        ...
        <div class="block-categories__list">
            <div class="block-categories__item category-card category-card--layout--classic">
                <div class="category-card__body">
                    <div class="category-card__image"><a href="#"><img
                                src="{{ asset('strokya/images/categories/category-1.jpg') }}" alt=""></a></div>
            ...
            <div class="block-categories__item category-card category-card--layout--classic">
                <div class="category-card__body">
                    <div class="category-card__image"><a href="#"><img
                                src="{{ asset('strokya/images/categories/category-2.jpg') }}" alt=""></a></div>
                    <div class="category-card__content">
            ...
            <div class="block-categories__item category-card category-card--layout--classic">
                <div class="category-card__body">
                    <div class="category-card__image"><a href="#"><img
                                src="{{ asset('strokya/images/categories/category-4.jpg') }}" alt=""></a></div>
                    <div class="category-card__content">
            ...
            <div class="block-categories__item category-card category-card--layout--classic">
                <div class="category-card__body">
                    <div class="category-card__image"><a href="#"><img
                                src="{{ asset('strokya/images/categories/category-3.jpg') }}" alt=""></a></div>
                    <div class="category-card__content">
            ...
            <div class="block-categories__item category-card category-card--layout--classic">
                <div class="category-card__body">
                    <div class="category-card__image"><a href="#"><img
                                src="{{ asset('strokya/images/categories/category-5.jpg') }}" alt=""></a></div>
                    <div class="category-card__content">
            ...
            <div class="block-categories__item category-card category-card--layout--classic">
                <div class="category-card__body">
                    <div class="category-card__image"><a href="#"><img
                                src="{{ asset('strokya/images/categories/category-6.jpg') }}" alt=""></a></div>
                    <div class="category-card__content">
...
<div class="block block-posts block-posts--layout--list-sm" data-layout="list-sm">
    <div class="container">
        ...
        <div class="block-posts__slider">
            <div class="owl-carousel">
                <div class="post-card">
                    <div class="post-card__image"><a href="#"><img src="{{ asset('strokya/images/posts/post-1.jpg') }}" alt=""></a>
                    </div>
                ...
                <div class="post-card">
                    <div class="post-card__image"><a href="#"><img src="{{ asset('strokya/images/posts/post-2.jpg') }}" alt=""></a>
                    </div>
                    <div class="post-card__info">
                ...
                <div class="post-card">
                    <div class="post-card__image"><a href="#"><img src="{{ asset('strokya/images/posts/post-3.jpg') }}" alt=""></a>
                    </div>
                    <div class="post-card__info">
                ...
                <div class="post-card">
                    <div class="post-card__image"><a href="#"><img src="{{ asset('strokya/images/posts/post-4.jpg') }}" alt=""></a>
                    </div>
                    <div class="post-card__info">
                        <div class="post-card__category"><a href="#">Special Offers</a></div>
                ...
                <div class="post-card">
                    <div class="post-card__image"><a href="#"><img src="{{ asset('strokya/images/posts/post-5.jpg') }}" alt=""></a>
                    </div>
                    <div class="post-card__info">
                        <div class="post-card__category"><a href="#">New Arrivals</a></div>
                ...
                <div class="post-card">
                    <div class="post-card__image"><a href="#"><img src="{{ asset('strokya/images/posts/post-6.jpg') }}" alt=""></a>
                    </div>
                    <div class="post-card__info">
                        <div class="post-card__category"><a href="#">Special Offers</a></div>
                        <div class="post-card__name"><a href="#">Logic Is The Study Of Reasoning And
                ...
                <div class="post-card">
                    <div class="post-card__image"><a href="#"><img src="{{ asset('strokya/images/posts/post-7.jpg') }}" alt=""></a>
                    </div>
                    <div class="post-card__info">
                        <div class="post-card__category"><a href="#">Special Offers</a></div>
                ...
                <div class="post-card">
                    <div class="post-card__image"><a href="#"><img src="{{ asset('strokya/images/posts/post-8.jpg') }}" alt=""></a>
                    </div>
                    <div class="post-card__info">
                        <div class="post-card__category"><a href="#">Latest News</a></div>
                ...
                <div class="post-card">
                    <div class="post-card__image"><a href="#"><img src="{{ asset('strokya/images/posts/post-9.jpg') }}" alt=""></a>
                    </div>
                    <div class="post-card__info">
                        <div class="post-card__category"><a href="#">New Arrivals</a></div>
                ...
                <div class="post-card">
                    <div class="post-card__image"><a href="#"><img src="{{ asset('strokya/images/posts/post-10.jpg') }}"
                                alt=""></a></div>
                    <div class="post-card__info">
                        <div class="post-card__category"><a href="#">Special Offers</a></div>
...
<div class="block block-brands">
    <div class="container">
        <div class="block-brands__slider">
            <div class="owl-carousel">
                <div class="block-brands__item"><a href="#"><img src="{{ asset('strokya/images/logos/logo-1.png') }}" alt=""></a>
                </div>
                <div class="block-brands__item"><a href="#"><img src="{{ asset('strokya/images/logos/logo-2.png') }}" alt=""></a>
                </div>
                <div class="block-brands__item"><a href="#"><img src="{{ asset('strokya/images/logos/logo-3.png') }}" alt=""></a>
                </div>
                <div class="block-brands__item"><a href="#"><img src="{{ asset('strokya/images/logos/logo-4.png') }}" alt=""></a>
                </div>
                <div class="block-brands__item"><a href="#"><img src="{{ asset('strokya/images/logos/logo-5.png') }}" alt=""></a>
                </div>
                <div class="block-brands__item"><a href="#"><img src="{{ asset('strokya/images/logos/logo-6.png') }}" alt=""></a>
                </div>
                <div class="block-brands__item"><a href="#"><img src="{{ asset('strokya/images/logos/logo-7.png') }}" alt=""></a>
                </div>
            </div>
        </div>
    </div>
