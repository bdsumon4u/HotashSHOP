...
<head>
    ...
    <style>
        ...
        .widget-connect{position:fixed;bottom:30px;z-index:99 !important;cursor:pointer}.widget-connect-right{right:27px;bottom:22px}.widget-connect-left{left:20px}@media (max-width:768px){.widget-connect-left{left:10px;bottom:10px}}.widget-connect.active .widget-connect__button{display:grid;place-content:center}.widget-connect__button{display:none;height:55px;width:55px;margin:auto;margin-bottom:15px;border-radius:50%;overflow:hidden;box-shadow:2px 2px 6px rgba(0, 0, 0, .4);font-size:28px;text-align:center;line-height:50px;color:#fff;outline:0
...
<body class="header-fixed" style="margin: 0; padding: 0;">
    ...
    <div class="widget-connect widget-connect-right">
        ...
        <a class="widget-connect__button widget-connect__button-telemessenger button-slide-out" href="{{$messenger}}" data-toggle="tooltip" data-placement="left" title="" target="_blank" data-original-title="Call us">
