...
<div class="row mb-5">
    <div class="col-sm-12">
        <div class="card rounded-0 shadow-sm">
            <div class="card-header p-3">Add New <strong>distributor</strong></div>
            <div class="card-body p-3">
                <x-form :action="route('admin.distributors.store')" has-files>
                    <div class="row">
                        <div class="col-md-8">
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <x-textarea name="address" rows="8" />
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label for="photo" class="d-block">
                                    <div>Photo</div>
                                    <img src="{{ asset($logo->desktop ?? '') ?? '' }}" alt="Photo" class="form-control img-responsive d-block {{$errors->has('photo') ? 'is-invalid' : 'border'}}" style="@unless($logo->desktop ?? '') display:none; @endunless height: 300px; width: 300px;">
