...
<div class="tab-pane active" id="item-color" role="tabpanel">
    @foreach(['topbar' => 'Top Bar', 'header' => 'Header', 'search' => 'Search', 'navbar' => 'Nav Bar', 'category_menu' => 'Category Menu', 'section' => 'Section', 'footer' => 'Footer', 'primary' => 'Primary Button', 'secondary' => 'Secondary Button'] as $id => $title)
