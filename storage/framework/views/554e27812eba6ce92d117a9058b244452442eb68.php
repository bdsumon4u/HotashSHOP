...
<?php $__env->startSection('title', 'Edit Home Section'); ?>
...
<?php $component = $__env->getContainer()->make(BladeUIKit\Components\Forms\Form::class, ['action' => route('admin.home-sections.update', $section),'method' => 'PATCH']); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\Forms\Inputs\Input::class, ['name' => 'title','value' => $section->title]); ?>
...
<?php endif; ?> 
                                <select selector name="type" id="type" class="form-control">
                                    <option value="carousel-grid" <?php echo e($section->type == 'carousel-grid' ? 'selected' : ''); ?>>Carousel Grid</option>
                                </select>
                                 <?php if (isset($component)) { $__componentOriginalabbd4326acdd37e9a3da88375af5ebdfd7b875a0 = $component; } ?>
...
<?php endif; ?> 
                                 <?php if (isset($component)) { $__componentOriginalc956e18133c2dd5e943dac2fe8204fec03883341 = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Forms\Inputs\Input::class, ['type' => 'number','name' => 'order','value' => $section->order]); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php $component = $__env->getContainer()->make(App\View\Components\CategoryDropdown::class, ['categories' => $categories,'name' => 'categories[]','placeholder' => 'Select Category','id' => 'categories','multiple' => 'true','selected' => old('categories', $section->categories->pluck('id')->toArray())]); ?>
...
<?php endif; ?> 
                                 <?php if (isset($component)) { $__componentOriginalc956e18133c2dd5e943dac2fe8204fec03883341 = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Forms\Inputs\Input::class, ['type' => 'number','name' => 'data[rows]','value' => $section->data->rows ?? 2]); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php endif; ?> <span>(4 or 5)</span>
                                 <?php if (isset($component)) { $__componentOriginalc956e18133c2dd5e943dac2fe8204fec03883341 = $component; } ?>
<?php $component = $__env->getContainer()->make(App\View\Components\Forms\Inputs\Input::class, ['type' => 'number','name' => 'data[cols]','value' => $section->data->cols ?? 5]); ?>
<?php $component->withName('input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php $component->withAttributes([]); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.light.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\XAMPP\htdocs\starter-kit\resources\views/admin/home-sections/edit.blade.php ENDPATH**/ ?>