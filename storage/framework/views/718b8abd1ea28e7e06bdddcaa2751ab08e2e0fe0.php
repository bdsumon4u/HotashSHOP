    ...
    <div class="indicator__dropdown">
        <div class="account-menu">
            <div class="account-menu__user-info w-100 text-center p-2">
                <div class="account-menu__user-name"><?php echo e(auth('user')->user()->name); ?></div>
                <div class="account-menu__user-email">
                    <?php echo e(auth('user')->user()->email); ?>

                    <br>
                    <?php echo e(auth('user')->user()->phone_number); ?>
...
<?php $component = $__env->getContainer()->make(BladeUIKit\Components\Forms\Form::class, ['action' => ''.e(route('user.logout')).'','method' => 'POST']); ?>
...
<?php endif; ?><?php /**PATH E:\XAMPP\htdocs\starter-kit\resources\views/partials/auth-indicator.blade.php ENDPATH**/ ?>