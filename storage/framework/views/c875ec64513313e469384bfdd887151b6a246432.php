...
<head>
    ...
    <title>Stroyka</title>
    <link rel="icon" type="image/png" href="<?php echo e(asset('strokya/images/favicon.png')); ?>"><!-- fonts -->
    <!-- css -->
    <?php echo $__env->make('layouts.yellow.css', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- js -->
    <!-- font - fontawesome -->
...
<body style="margin: 0; padding: 0;">
            ...
            <div class="mobilemenu__header">
                ...
                <button type="button" class="mobilemenu__close">
                    <svg width="20px" height="20px">
                        <use xlink:href="<?php echo e(asset('strokya/images/sprite.svg#cross-20')); ?>"></use>
                    </svg>
                </button>
            </div>
            <div class="mobilemenu__content">
                <ul class="mobile-links mobile-links--level--0" data-collapse data-collapse-opened-class="mobile-links__item--open">
                    <?php echo $__env->make('partials.mobile-menu-categories', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    <?php echo $__env->make('partials.header.menu.mobile', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </ul>
            </div>
        </div>
    </div><!-- mobilemenu / end -->
    ...
    <div class="site">
        ...
        <?php echo $__env->make('partials.header.desktop', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $component->withAttributes(['class' => 'row mt-2']); ?>
...
<?php endif; ?> 
    ...
    <?php echo $__env->make('layouts.yellow.js', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <script>
        $(document).ready(function () {
                    ...
                    return `<div class="dropcart__product" data-id="${v.id}">
                        ...
                        <button type="button" class="dropcart__product-remove btn btn-light btn-sm btn-svg-icon" remove-cart-item data-id="${v.id}">
                            <svg width="10px" height="10px">
                                <use xlink:href="<?php echo e(asset('strokya/images/sprite.svg#cross-10')); ?>"></use>
                            </svg>
                        </button>
                    </div>`;
                        ...
                        <td class="cart-table__column cart-table__column--remove">
                            <button type="button" class="btn btn-light btn-sm btn-svg-icon" remove-cart-item data-id="${v.id}">
                                <svg width="12px" height="12px">
                                    <use xlink:href="<?php echo e(asset('strokya/images/sprite.svg#cross-12')); ?>"></use>
                                </svg>
                            </button>
                        </td>
                    </tr>`;
            ...
            $('.product-card__addtocart, .product-card__ordernow').on('click', function (ev) {
                ...
                if ($(this).hasClass('product-card__ordernow')) {
                    window.location = "<?php echo e(route('checkout')); ?>";
                }
            });
...
</html><?php /**PATH E:\XAMPP\htdocs\starter-kit\resources\views/layouts/yellow/master.blade.php ENDPATH**/ ?>