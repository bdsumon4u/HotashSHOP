      ...
      <ul class="nav-menus">
        <li class="language-nav">
          <div class="translate_wrapper">
            ...
            <div class="more_lang">
              ...
              <a href="<?php echo e(route('lang' , 'es' )); ?>" class="<?php echo e((App::getLocale()  == 'es') ? 'active' : ''); ?>">
        ...
        <li class="cart-nav onhover-dropdown">
          ...
          <ul class="cart-dropdown chat-dropdown onhover-show-div">
            ...
            <li>
              <div class="media">
                <img class="img-fluid rounded-circle mr-3 img-60" src="<?php echo e(asset('assets/images/ecommerce/02.jpg')); ?>" alt="">
                <div class="media-body">
            ...
            <li>
              <div class="media">
                <img class="img-fluid rounded-circle mr-3 img-60" src="<?php echo e(asset('assets/images/ecommerce/08.jpg')); ?>" alt="">
                <div class="media-body">
                  <span>Girls's T-shirt</span>
                  <p>It is a long established fact that a reader</p>
...
<?php /**PATH H:\Cuba\laravel\starter-kit\resources\views/layouts/vertical/header.blade.php ENDPATH**/ ?>