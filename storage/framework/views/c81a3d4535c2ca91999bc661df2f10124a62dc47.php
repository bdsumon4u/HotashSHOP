    ...
    <div class="main-header-left">
      <div class="logo-wrapper">
        <a href="<?php echo e(route('/')); ?>">
          <img class="img-fluid" src="<?php echo e(asset($logo->desktop ?? '')); ?>" alt="Logo">
        </a>
      </div>
      ...
      <ul class="nav-menus">
        ...
        <li class="profile-nav onhover-dropdown p-0">
          ...
          <ul class="profile-dropdown onhover-show-div">
            ...
            <li>
              <a href="<?php echo e(route('admin.settings')); ?>"><i data-feather="settings"></i><span>Settings</span></a>
            </li>
            <li>
...
<?php /**PATH E:\XAMPP\htdocs\starter-kit\resources\views/layouts/light/header.blade.php ENDPATH**/ ?>